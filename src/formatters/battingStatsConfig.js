export const battingStatConfig = [
	...
	},
	{
		...
		getValue: (data) => data?.exitVeloBarrels?.ev95percent ?? data?.custom?.hard_hit_percent
	},
	{
		key: 'brl_percent',
		...
		getValue: (data) => data?.exitVeloBarrels?.brl_percent ?? data?.custom?.barrel_batted_rate
	},
	{
		key: 'xwoba',
		percentileKey: 'xwoba',
		...
		category: 'expected',
		decimals: 3,
		description: 'Expected Weighted On-Base Average based on hit exit velocity and launch angle.',
	...
	},
	{
		...
		category: 'expected',
		decimals: 3,
		description: 'Expected Batting Average based purely on quality of contact and launch angle.',
	...
	},
	{
		...
		category: 'expected',
		decimals: 3,
		description: 'Expected Slugging Percentage measuring modeled extra-base power.',
	...
	// ==========================================
	{
		...
		decimals: 1,
		unit: '%',
		description: 'Percentage of batted balls produced with a launch angle between 8° and 32°.',
		getValue: (data) =>
			data?.exitVeloBarrels?.anglesweetspotpercent ?? data?.custom?.sweet_spot_percent
	},
	{
		key: 'avg_hit_angle',
		...
		decimals: 1,
		unit: '°',
		description: 'The average launch angle (in degrees) of all hit balls off the bat.',
	...
	},
	{
		...
		decimals: 0,
		unit: 'ft',
		description: 'The longest distance in feet recorded on any single batted ball.',
	...
	},
	{
		...
		decimals: 1,
		unit: '%',
		description: 'The percentage of maximum possible exit velocity achieved based on swing speed.',
	...
	},
	{
		...
		decimals: 1,
		unit: 'ft/s',
		description: 'Feet per second in a player’s top 1-second window on full sprint plays.',
		getValue: (data) => data?.percentiles?.sprint_speed_val
	},
	{
		key: 'runner_runs_tot',
		...
		category: 'running',
		decimals: 1,
		description: 'Total runs added or lost on the basepaths relative to an average runner.',
	...
	},
	{
		...
		category: 'run_value',
		decimals: 1,
		description: 'Total run value added by taking plate appearances based on the Swing-Take model.',
